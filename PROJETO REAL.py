...
def Ppag():
    ...
    def Altpag():
        def AltArq():
            ...
            btnconf = Button(menu, text="Confirmar",  width= 23,bg="Black",fg="White")
    ...
    def Pesq():
        def PesqArq():
            ...
            Label3 = Label(menu,text="------------------------------------------------------------------------------------------------------------------------Realizando Pesquisa------------------------------------------------------------------------------------------------------------------------",bg="Black",fg="White", font="Courier 10 bold")
            Label3.pack()
            ...
            btnconf = Button(menu, text="Pesquisar", width= 23,bg="Black",fg="White")
            btnconf.place(x=835, y=260)
        ...
        Label2 = Label(menu,text="------------------------------------------------------------------------------------------------------------------------Escolha a opção desejada para Pesquisar------------------------------------------------------------------------------------------------------------------------:",bg="Black",fg="White", font="Courier 10 bold")
        Label2.pack()
    
        btnA = Button(menu, text="Arquiteto" ,command=PesqArq,  width= 23,bg="Black",fg="White")
        btnA.place(x=865, y=75)
        
        btnC = Button(menu, text="Cliente" ,command=PesqCli,  width= 23,bg="Black",fg="White")
        btnC.place(x=865, y=125)
    ...
    #botao P
    btn4 = Button(menu, text="Pesquisar" ,command=Pesq, width= 23,bg="Black",fg="White")
